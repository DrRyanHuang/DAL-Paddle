...
class VOCDataset(paddle.io.Dataset):
    ...
    def __init__(self,
        ...
        self.data_path = self.image_set.replace('/ImageSets/Main/trainval.txt', "")
        self.image_ext = [".jpg"]
    ...
    def __getitem__(self, index):
        ...
        gt_inds = np.where(roidb['gt_classes'] != 0)[0] # remove __background__ class
        ...
        for i, bbox in enumerate(bboxes):
            gt_boxes[i, :5] = quad_2_rbox(np.array(bbox)) # xy xy degree
