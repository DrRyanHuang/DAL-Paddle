...
if __name__ == "__main__":
    ...
    parser.add_argument('--gt_path', type=str, required=True, default='PascalVOC2007/VOC2007_test/ImageSets/Main/test.txt')
    parser.add_argument('--dst_path', type=str, default='ground-truth', help='GT path generated')
    parser.add_argument('--eval_difficult', action='store_true', help='whether to eval difficult object')

    arg = parser.parse_args()

    convert_voc_gt(arg.gt_path, arg.dst_path, arg.eval_difficult)
